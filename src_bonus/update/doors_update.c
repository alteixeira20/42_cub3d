...
/*   Updated: 2025/09/09 21:21:26 by jopedro-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	update_one(t_door *d, t_vec2 p, float dt)
{
	float	cx;
	float	cy;
	float	r2;
...
void	update_doors_for_frame(t_game *cube)
{
	...
	doors_update(&cube->doors, cube->map.grid, p, (float)cube->dt);
}
